...
if (QUICKUPDATES_DISPLAY_ID == 'QUICKUPDATES_DISPLAY_ID' && ($_GET['qu_installer'] != 'install')) { // admin area config not installed
	$messageStack->add(sprintf('Quick Updates Konfiguration ist noch nicht installiert. Bitte installieren Sie die Konfiguration und clicken Sie auf %sInstall%s', '<a href="' . zen_href_link(FILENAME_QUICK_UPDATES, 'qu_installer=install') . '">', '</a>'), 'warning');
}
...
?>
      ...
      <div style="text-align:right;"><a href="<?php echo zen_href_link(FILENAME_QUICK_UPDATES, 'qu_installer=remove') ?>">Quick Updates deinstallieren</a><br/></div>
